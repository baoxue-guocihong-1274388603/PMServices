<?php
	...
	if ($OperationType === "AddDevice") {
		...
		$sql = "INSERT INTO dtm_deviceinfo_beijing_table VALUES('".$DeviceID."','".$MonitorPoint."')";
		...
		$sql = "DELETE FROM dtm_deviceinfo_beijing_table WHERE device_id = '".$DeviceID."'";
		$result = mysqli_query($link,$sql);
	...
	$DeviceData = array();
	$sql = "SELECT * FROM dtm_deviceinfo_beijing_table ORDER BY device_id ASC";
	$result = mysqli_query($link,$sql);
